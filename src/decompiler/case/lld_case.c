/*
** lldCase.c for Corewar in /CPE_2015_corewar/src/decompiler
**
** Made by Antoine Baché
** Login   <bache_a@epitech.net>
**
** Started on  Thu Feb 25 01:03:06 2016 Antoine Baché
** Last update Thu Feb 25 13:56:15 2016 Antoine Baché
*/
...
int	lldCase(t_read *data)
{
  ...
  my_bzero(data->buff, 5);
  if (read(data->fd, data->buff, 1) < 0 ||
      write(data->new, data->inst[12], my_strlen(data->inst[12])) < 0)
    return (1);
  ...
  while (++i < 4)
    {
      ...
      my_bzero(data->buff, 5);
      if (!code && lldRegister(data))
	return (1);
      if (code == 1 && lldDirect(data))
	return (1);
      if (code == 2 && lldIndirect(data))
	return (1);

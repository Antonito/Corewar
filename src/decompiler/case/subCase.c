/*
** subCase.c for Corewar in /CPE_2015_corewar/src/decompiler
**
** Made by Antoine Baché
** Login   <bache_a@epitech.net>
**
** Started on  Thu Feb 25 01:03:06 2016 Antoine Baché
** Last update Thu Feb 25 02:24:24 2016 Antoine Baché
*/
...
int	subCase(t_read *data)
{
  ...
  my_bzero(data->buff, 5);
  if (read(data->fd, data->buff, 1) < 0 ||
      write(data->new, data->inst[4], my_strlen(data->inst[4])) < 0)
    return (1);
